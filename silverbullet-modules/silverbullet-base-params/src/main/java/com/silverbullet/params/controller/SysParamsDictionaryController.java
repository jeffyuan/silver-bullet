...
import com.silverbullet.params.common.DictionaryTypeMap;
...
import com.silverbullet.params.utils.SysParamsDictionaryDataFormat;
...
public class SysParamsDictionaryController {
    ...
    public ModelAndView index(){
        ...
        // 替换类型的显示内容
        SysParamsDictionaryDataFormat.formatType(results, DictionaryTypeMap.getDictionTypeMap());
...
//        System.out.println(id);
    ...
    public String add(Model model) {
        ...
        model.addAttribute("typeinfo", DictionaryTypeMap.getDictionTypeMap());
