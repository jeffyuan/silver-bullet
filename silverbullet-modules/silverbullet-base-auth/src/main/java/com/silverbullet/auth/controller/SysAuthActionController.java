...
//        BaseDataResult<SysAuthAction> results = sysAuthActionService.list("NONE", nCurPage, 5 );
//
...
//        modelAndView.addObject("curPage", nCurPage);
    ...
    public List<Map<String,Object>> listData(String parentId){
        ...
        List<Map<String, Object>> results = sysAuthActionService.getActionByParentId(parentId);
        return results;
    }
    ...
    public String add(Model model, String parentId) {
        ...
        SysAuthAction sysAuthAction = new SysAuthAction();
        sysAuthAction.setParentId(parentId);

        model.addAttribute("obj", sysAuthAction);
