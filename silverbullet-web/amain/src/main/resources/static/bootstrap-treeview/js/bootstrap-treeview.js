...
;(function ($, window, document, undefined) {
	...
	*/
	...
	Tree.prototype._renderNode = function (node, previousNode) {
		...
		//Add sort
        node.$el.attr("sort", node.sort);

		//Add parentId
        node.$el.attr("parentuid", node.parentuid);
	...
	Tree.prototype._template = {
		...
		node: $('<li class="list-group-item" onclick="treeClick(this)" onmouseenter="treeEnter(this)" onmouseleave="treeLeave(this)"></li>'),
